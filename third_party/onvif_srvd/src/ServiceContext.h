...
class StreamProfile
{
    public:
        ...
        tt__AudioSourceConfiguration*  get_audio_src_cfg(struct soap *soap) const;
        ...
        bool set_audio_type(const char *new_val);
        bool set_audio_rate(const char *new_val);
        bool set_audio_bitrate(const char *new_val);
